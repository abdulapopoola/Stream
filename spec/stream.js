...
describe('Stream()', function () {
  ...
  it('head throws an exception for empty Streams', function () {
    ...
    expect(stream.head.bind(stream)).to.throw('Stream is empty!');
    expect(stream.tail.bind(stream)).to.throw('Stream is empty!');
  });
  ...
  it('can create Stream with only one value', function () {
    ...
    expect(stream.tail.bind(stream)).to.not.throw('Stream is empty!');
    expect(stream.isEmpty()).to.equal(false);
  });
